...
if (process.argv.length < 7){
    console.log('node tls2.js [Method] [Target] [Proxy List] [Time] [Requests Per IP] [Threads]');
...
if (headerbuilders !== undefined){
    ...
    console.log(`[Broadcast] SUCCES : Attack hast sent succesfully!`);
    console.log(`[Broadcast] Host:${process.argv[3]}`);
    console.log(`[Broadcast] Method:${process.argv[2]}`);
    console.log(`[Broadcast] Time:${process.argv[4]}`);
    console.log(`[Broadcast] Threads:${process.argv[6]}/${process.argv[5]}`);
    console.log(`[Broadcast] Total Attack:${process.argv[7]}`);
    console.log(``);
...
"Opera/8.01 (Macintosh; U; PPC Mac OS; en)","Opera/8.01 (Macintosh; PPC Mac OS X; U; en)",
"Mozilla/5.0 (Windows NT 5.1; U; en) Opera 8.01",
"Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; ru) Opera 8.01",	"Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; en) Opera 8.01",
...
"Mozilla/4.0 (compatible; MSIE 5.0; Windows NT 4.0) Opera 6.02  [en]",	"Mozilla/4.0 (compatible; MSIE 5.0; Windows 95) Opera 6.02  [en]",
...
"Mozilla/5.0 (Windows NT 6.1; rv:12.0) Gecko/20120403211507 Firefox/12.0","Mozilla/5.0 (Windows NT 6.1; de;rv:12.0) Gecko/20120403211507 Firefox/12.0",
...
"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:11.0) Gecko Firefox/11.0","Mozilla/5.0 (Windows NT 6.1; U;WOW64; de;rv:11.0) Gecko Firefox/11.0",
...
"Mozilla/5.0 (X11; U; Linux x86_64; en-US; rv:1.8.1.19) Gecko/20081213 SUSE/2.0.0.19-0.1 Firefox/2.0.0.19","Mozilla/5.0 (X11; U; Linux i686; fr; rv:1.8.1.19) Gecko/20081216 Ubuntu/7.10 (gutsy) Firefox/2.0.0.19",
"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.8.1.19) Gecko/20081230 Firefox/2.0.0.19",
"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.8.1.19) Gecko/20081216 Fedora/2.0.0.19-1.fc8 Firefox/2.0.0.19 pango-text","Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.8.1.19) Gecko/20081213 SUSE/2.0.0.19-0.1 Firefox/2.0.0.19","Mozilla/5.0 (X11; U; Linux i686; de; rv:1.8.1.19) Gecko/20081213 SUSE/2.0.0.19-0.1 Firefox/2.0.0.19","Mozilla/5.0 (Windows; U; Windows NT 6.0; zh-CN; rv:1.8.1.20) Gecko/20081217 Firefox/2.0.0.19",
...
"Mozilla/5.0 (X11; U; Linux i686; pl; rv:1.8.1) Gecko/20061127 Firefox/2.0 (Gentoo Linux)","Mozilla/5.0 (X11; U; Linux i686; pl; rv:1.8.1) Gecko/20061127 Firefox/2.0",
